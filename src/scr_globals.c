...
char scr_cntl_base[SCR_MAX_FILENAME]  = SCR_CNTL_BASE;
char scr_cache_base[SCR_MAX_FILENAME] = SCR_CACHE_BASE;

char* scr_cntl_prefix = NULL;
char scr_par_prefix[SCR_MAX_FILENAME]   = "";

/* these files live in the control directory */
char scr_master_map_file[SCR_MAX_FILENAME];
char scr_map_file[SCR_MAX_FILENAME];
char scr_transfer_file[SCR_MAX_FILENAME];
...
scr_filemap* scr_map = NULL;
scr_hash* scr_halt_hash = NULL;
...
int scr_hop_distance     = SCR_HOP_DISTANCE;     /* number of nodes away to choose parnter */
...
int scr_preserve_user_directories = SCR_PRESERVE_USER_DIRECTORIES;
int scr_use_containers            = SCR_USE_CONTAINERS;
unsigned long scr_container_size  = SCR_CONTAINER_SIZE;
