...
char scr_par_prefix[SCR_MAX_FILENAME] = ""; /* path of SCR_PREFIX directory on PFS */
...
int scr_preserve_user_directories = SCR_PRESERVE_USER_DIRECTORIES; /* whether to preserve user-defined directories during flush */
