...
# run from an interactive allocation of 4 nodes
# get an allocation
#mxterm 4 32 120
#salloc -N4 -ppdebug
#lalloc 4 -q pdebug
...
echo "check that scr_list_down_nodes returns good values"
...
${PYFEBIN}/scr_halt.py --checkpoints 5 `pwd`; sleep 3
...
#${PYFEBIN}/scr_srun.py -n4 -N4 ./test_api_hang
#echo "scr_srun returned, try to restart (should get the checkpoint that was just made)"
#unset SCR_WATCHDOG
