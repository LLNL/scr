...
if __name__=='__main__':
  ...
  if len(sys.argv)<3 or '-h' in sys.argv[1:] or '--help' in sys.argv[1:]:
    ...
    launcher, launcher_args, run_cmd, restart_cmd, restart_args = parseargs(sys.argv[1:],launcher='jsrun')
    scr_run(launcher='jsrun', launcher_args=launcher_args, run_cmd=run_cmd, restart_cmd=restart_cmd, restart_args=restart_args)
